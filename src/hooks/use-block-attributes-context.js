...
const AttributesContext = createContextSelector(
	DEFAULT_BLOCK_ATTRIBUTES_CONTEXT
);
const SetAttributesContext = createContext( DEFAULT_SET_ATTRIBUTES_CONTEXT );
const BlockContextContext = createContextSelector(
	DEFAULT_BLOCK_CONTEXT_CONTEXT
);
